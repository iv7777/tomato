...
var m = [
	...
	{ title: 'Color Scheme', name: 'web_css', type: 'select',
		options: [['modern','Modern'],['red','Tomato'],['asus','Asustek'],['black','Black'],['blue','Blue'],['bluedream','Bluedream'],['brownlight','Brownlight'],['brown','Brown'],['cisco','Cisco'],['cyan','Cyan'],['enlightened','Enlightened'],['linksys','Linksys'],['olive','Olive'],['ext/custom','Custom (ext/custom.css)'], ['online', 'On-line from TTB']], value: nvram.web_css },
